...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    @foreach($fietsen as $fiets)
        <div class="shadow-md rounded-md overflow-hidden transform transition duration-500 hover:scale-105">
            ...
            <div class="p-6">
                <h2 class="text-xl font-semibold mb-2">{{ $fiets->Naam }}</h2>
                <p class="text-gray-700 mb-4">{{ $fiets->Beschrijving }}</p>
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <button class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-900 add-to-cart-btn"
                                data-id="{{ $fiets->FietsId }}"
                                data-type="fiets"
                                data-hoeveelheid="1">
                            In winkelwagen
                        </button>
